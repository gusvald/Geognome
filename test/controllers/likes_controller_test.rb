...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference("Like.count") do
      post likes_url, params: { like: { gnome_id: @like.gnome_id, profile_id: @like.profile_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { gnome_id: @like.gnome_id, profile_id: @like.profile_id } }
